...
// *******************************
// With minor modifications, took from CodeProject and under CPOL License (http://www.codeproject.com/info/cpol10.aspx)
// Article: http://www.codeproject.com/Articles/646296/A-Cross-platform-Csharp-Class-for-Using-INI-Files
                ...
                if (OriginalFileExists)
                {
                    ...
                    try
                    {
                        ...
                        while (Reading)
                        {
                            ...
                            if (Unmodified && !string.IsNullOrWhiteSpace(s))
                            {
                                if (s.StartsWith("["))
                                {
                                    if (!isFirstSection)
